      ...
      >
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            >
              🚀 OpenRouter AI SDK v4 - React Demo
            </h1>
            <p
              style={{
                fontSize: '1.25rem',
            ...
            >
              Test OpenRouter AI SDK v4 with basic and streaming chat
              functionality using Next.js App Router and AI SDK v4
            </p>
          </div>
          ...
          >
            ...
            <p style={{ marginTop: '0.5rem', fontStyle: 'italic' }}>
              Using AI SDK v4 with Next.js App Router! 🎉
            </p>
          </div>
        </div>
      </main>
