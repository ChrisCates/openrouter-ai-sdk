...
import { ReasoningDetailArraySchema } from '../schemas/reasoning'
import { convertToOpenRouterCompletionPrompt } from '../utils/convert/completion.prompt'
...
interface OpenRouterCompletionConfig {
  provider: string
